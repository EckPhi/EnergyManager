"""Pricing contracts: DTOs shared between the pricing layer and the scheduler."""
...
@dataclass
class PriceSeries:
    """A sequence of provider-native price points. Never consumed directly by the scheduler."""
